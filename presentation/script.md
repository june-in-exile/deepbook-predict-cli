...
> 場合:技術受眾簡報(開發者 / 技術團隊)
> 預計時長:約 17–20 分鐘
> 對應投影片:`present.html`(15 頁含 Live Demo 收尾;References 不另講)
...
- 整體節奏:前段(slide 2–7)鋪陳「現有預測市場 → 痛點 → 視角換成選擇權 → 量化 → 破除誤解」,**比較感性的 framing**;中段(8–12)是技術細節,**節奏放穩**;後段(13)是創新點 climax;14–15 拉回誠實感跟 demo。
...
- 如果時間緊,可砍 slide 11 的細節,直接帶過「五步、< 400ms、binary 跟 range 對稱」。
- 如果觀眾偏 LP / 金融,slide 13 多花 30 秒講提款限制器的設計。
- 如果觀眾偏 builder / SDK,slide 11 多花 30 秒講「對稱路徑」的意義。
