...
下一頁開始,看 DeepBook Predict 怎麼用 infra 的思維,把這三件事一次解掉。

---

## Slide 4 · Predict ≠ 傳統預測市場
...
- 整體節奏:前段(slide 2–7)鋪陳「現有預測市場 → 痛點 → 對比 → 量化」,**比較感性的 framing**;中段(8–12)是技術細節,**節奏放穩**;後段(13)是創新點 climax;14–15 拉回誠實感跟 demo。
...
- Slide 5 是橋段,只有一句話,**講完就切下一頁**,不要在這頁停太久——它是給後面 payoff shapes 鋪框架用的。
- Slide 7 跟 Slide 3 是**呼應結構**——Slide 3 給質性痛點、Slide 7 給量化證據。講 Slide 7 時可以**回頭指 Slide 3**(「還記得剛剛那三個痛點嗎?$100M 平坦 TVL 就是它們的後果」)。
